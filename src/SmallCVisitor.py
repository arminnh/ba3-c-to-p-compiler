...
class SmallCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SmallCParser#pointerPart.
    def visitPointerPart(self, ctx:SmallCParser.PointerPartContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SmallCParser#declarator1.
    def visitDeclarator1(self, ctx:SmallCParser.Declarator1Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SmallCParser#declarator2.
    def visitDeclarator2(self, ctx:SmallCParser.Declarator2Context):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SmallCParser#returnStmt.
    def visitReturnStmt(self, ctx:SmallCParser.ReturnStmtContext):
        return self.visitChildren(ctx)
